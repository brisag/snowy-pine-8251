...
RSpec.describe 'As a visitor' do
  describe "When I visit a Airlines's show page" do
    before :each do
    ...
    it "I see a unique list of passengers that have flights on that airline" do
      # save_and_open_page
      expect(@airline_1.find_adult_passengers).to eq([@passenger_1, @passenger_2, @passenger_3, @passenger_4])
      expect(@airline_1.find_adult_passengers).to_not eq([@passenger_5])
    end

    it "shows a list of sorted by count of flight from most to least" do
    end
  end
end
